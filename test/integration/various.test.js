...
test('various specific issue tests', {timeout: 60000}, function (suite) {
    ...
    suite.test('MANTA-796: URL encoding', function (t) {
        var k = dir + '/foo\'b';
    ...
    suite.test('MANTA-646: mkdir race', function (t) {
        var runs = 0;
    ...
    suite.test('MANTA-646: mkdirp race', function (t) {
        var runs = 0;
    ...
    suite.test('MANTA-1072 no etag', function (t) {
        var runs = 0;
    ...
    suite.test('MANTA-1072 conditional', function (t) {
        var sawError = false;
        var runs = 0;
    ...
    // suite.test('MANTA-792: email as login', function (t) {
    ...
    suite.test('MANTA-796: URL encode directory', function (t) {
    ...
    suite.test('MANTA-1593: URL encode object', function (t) {
    ...
    suite.test('MANTA-1593: URL encoded listing', function (t) {
        var opts = {
            size: Buffer.byteLength(TEXT),
            type: 'text/plain'
        };
    ...
    // Requires x-dc setup
    // suite.test('MANTA-1853: ENOSPACE on durability-level=6', function (t) {
