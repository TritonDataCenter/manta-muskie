...
function configure(appName, opts, dtProbes) {
    ...
    /*
     * For streaming PUTs, we may not know the full size of the object until the
     * completion of the request.  For object placement, we must know in advance
     * the maximum expected size of the stream.  If the client does not provide
     * a "Max-Content-Length" header, we assume a default value.  An operator
     * may override this value by using the
     * "MUSKIE_DEFAULT_MAX_STREAMING_SIZE_MB" SAPI property.
     */
